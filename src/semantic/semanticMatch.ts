...
const PROFILE_ALIASES: Record<ProfileKey, string[]> = {
  ...
  jobTitle: ["job title", "role", "designation", "position", "current role", "title"],
  address: ["address", "street address", "address line", "residence line", "line 1"],
  city: ["city", "town", "municipality", "locality"],
  state: ["state", "province", "region", "province region"],
  postalCode: ["postal code", "postcode", "zip", "zip code", "pin code"],
  country: ["country", "nation", "residence", "nation of residence", "citizenship", "geo region"],
  linkedin: ["linkedin", "linkedin url", "linkedin profile", "professional profile"],
  website: ["website", "portfolio", "homepage", "personal site", "site url"],
  ...
  notes: ["notes", "message", "comments", "about you", "additional info", "additional notes"],
